...
class RejectedMessage : ComponentActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            RejectedMessageScreen()
        }
    }
}
...
fun RejectedMessageScreen(){
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = " We regret to inform you that your application has been rejected. Please review and update your details before reapplying. Thank you for your understanding.",
